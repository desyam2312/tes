  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo site_url('admin/crud_posyandu/')?>">
							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td width ="250">
										<?php if($karang->hasil=="InProgress"){ ?>
											<div class="btn-group" role="group" aria-label="input button">
											<a href="<?php echo site_url('admin/crud_karang/edit/'.$karang->id)?>" class="btn btn-small text-warning"><i class="fas fa-key"></i>Action</a>
                                        	</div>
                                        <?php } else{
                                               echo"$karang->hasil";    
                                        ?> <div class="btn-group" role="group" aria-label="input button">
											<a href="<?php echo site_url('admin/crud_karang/edit/'.$karang->id)?>" class="btn btn-small text-info"><i class="fas fa-key"></i>Edit</a>
                                        	</div> 
                                        <?php }?>										
