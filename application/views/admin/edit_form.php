          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Overview</li>
					...
					<div class="card-body">
						...
						<form action="<?php base_url('admin/crud_karang/edit/') ?>" method="post" enctype="multipart/form-data" >
							
							<div class="form-group">
								<input class="form-control <?php echo form_error('id') ? 'is-invalid':'' ?>"
								 type="hidden" name="id" value="<?php echo $karang->id?>" />
								<input class="form-control <?php echo form_error('user_id') ? 'is-invalid':'' ?>"
								 type="hidden" name="user_id" value="<?php echo $karang->user_id?>" />
								<input class="form-control <?php echo form_error('nama_ketua') ? 'is-invalid':'' ?>"
								 type="hidden" name="nama_ketua" value="<?php echo $karang->nama_ketua?>" />
								<input class="form-control <?php echo form_error('nama_kegiatan') ? 'is-invalid':'' ?>"
								 type="hidden" name="nama_kegiatan" value="<?php echo $karang->nama_kegiatan?>" />
								 <input class="form-control <?php echo form_error('tujuan_kegiatan') ? 'is-invalid':'' ?>"
								 type="hidden" name="tujuan_kegiatan" value="<?php echo $karang->tujuan_kegiatan?>" />
								 <input class="form-control <?php echo form_error('tanggal_kegiatan') ? 'is-invalid':'' ?>"
								 type="hidden" name="tanggal_kegiatan" value="<?php echo $karang->tanggal_kegiatan?>"/>
								 <input class="form-control <?php echo form_error('rab') ? 'is-invalid':'' ?>"
								 type="hidden" name="rab" min="0" value="<?php echo $karang->rab?>" />
								 <input class="form-control <?php echo form_error('proposal') ? 'is-invalid':'' ?>"
								 type="hidden" name="proposal" value="<?php echo $karang->proposal?>"/>
								<label>ACTION</label>
